...
<BannerMessage status='information' button="Click here">
	<BannerMessage.Header>header</BannerMessage.Header>
</BannerMessage>
```

#### Banner Message, with paragraph
...
<div style={{border: '1px solid black'}}>
	<h1 style={{padding: '10px', background: 'gray', margin: '0px', position: 'relative'}}>My App</h1>
	<BannerMessage status='error' 
		onCloseClicked={obj => {
	...
	<section style={{background: '#F1F1F2', padding: '10px'}}>
