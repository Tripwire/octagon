...
import { Radio , Dropdown, Input, Checkbox, Button, Popup } from 'semantic-ui-react'
...
storiesOf('Interactive Controls', module)
  ...
  .add('Time Selection Dropdown', () => (
    <Dropdown 
      ...
      style={{fontSize: "23px", marginLeft : "5px"}}></i>} 
  ...
  .add('Operation Control', () => (
    <div>
      ...
      <StopStartButton isStopped={true} style={{fontSize: "25px"}} />
    </div>
  ))
  .add('Popup Neutral', () => (
    <div>
