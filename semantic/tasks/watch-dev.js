/*******************************
 * @tw injected
 * modified ./watch task to drop compression and slow ops
*******************************/

const octagonBuilder = require('../../scripts/builder')
var
...
module.exports = function(callback) {
  ...
  //console.clear();
  console.log('watch-dev: Watching source files for changes');
    ...
    .watch([
      ...
      if( fs.existsSync(lessPath) ) {
        ...
        uncompressedStream
          ...
          .pipe(print(log.created))
          .on('end', function () {
            octagonBuilder.cssDist()
            .then(() => {
              console.log('css dist updated')
